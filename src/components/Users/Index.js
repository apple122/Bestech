                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse idExample" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <form method='POST' onSubmit={Submit_Users}>
                                                <div class="accordion-body row">
                                                    ...
                                                    <div className='col-md-12'>
                                                        <button type='submit' className='btn btn-sm btn-info mr-2'><i class="bi bi-cloud-download"></i> ບັນທືກ</button>
                                                        <button type='reset' className='btn btn-sm btn-danger'><i class="bi bi-x-diamond-fill"></i> ຍົກເລີກ</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="accordion-collapse idExample">
                                            <form method='POST' onSubmit={Edit_Users}>
                                                <div class="accordion-body row">
                                                    ...
                                                    <div className='col-md-12'>
                                                        <button type='submit' className='btn btn-sm btn-info mr-2'><i class="bi bi-cloud-download"></i> ບັນທືກການແກ້ໄຂ</button>
                                                        <button type='reset' onClick={cancel} className='btn btn-sm btn-danger'><i class="bi bi-x-diamond-fill"></i> ຍົກເລີກ</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
